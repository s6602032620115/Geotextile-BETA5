...
with col_right:
    ...
    with tab1:
        ...
        # SVG Dimension & Scaling (ขยับ ox เป็น 160 เพื่อเพิ่มพื้นที่ด้านซ้าย)
        svg_w, svg_h = 650, 520
        ox, oy = 160, 390
        ...
        <svg width="100%" height="{svg_h}" viewBox="0 0 {svg_w} {svg_h}" xmlns="http://www.w3.org/2000/svg" style="background:#090d16; border-radius:16px; border:1px solid #1e293b; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
            ...
            <!-- Reinforced Soil Text (จัดกึ่งกลางพื้นที่ดินถม ไม่ทับบล็อกซ้าย) -->
            ...
            <!-- Dimension H (ด้านซ้าย - ขยับออกห่างจากกำแพงบล็อกอย่างเห็นได้ชัด) -->
