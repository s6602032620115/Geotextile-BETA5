...
st.caption("ระบบออกแบบและตรวจสอบเสถียรภาพกำแพงกันดินเสริมกำลัง Geotextile พร้อมแอนิเมชันและรูปภาพหน้างานจริง")
    ...
    <div class="anime-card">
        ...
        <div>
            ...
            <div style="font-size: 13.5px; font-weight: normal; margin-top: 3px;">
                {"คำนวณผ่านเรียบร้อยค่ะ! แบบจำลองการไหลของแรงดึงและการบดอัดดินทำงานสมบูรณ์แล้วค่ะ ✨" if all_pass else "อุ๊ปส์! บางค่าไม่ผ่านเกณฑ์ความปลอดภัย ลองปรับความยาว L หรือเปลี่ยนเกรด Geotextile ดูนะคะ! 💡"}
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col_right:
    tab1, tab2 = st.tabs(["🎬 หน้าตัดจำลองแอนิเมชัน (Animated Visual)", "📸 ภาพบรรยากาศหน้างานจริง (Site Photos)"])
    ...
    with tab2:
        st.markdown("#### 👷 ภาพบรรยากาศการติดตั้งแผ่นสังเคราะห์ Geotextile และงานหน้างานจริง")
        ...
        with col_img1:
            st.image(
                ...
                caption="1. การปูแผ่นสังเคราะห์ Geotextile ดึงตึงบนชั้นดินถม",
                use_container_width=True
            )
            
            st.image(
                "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=600&q=80",
                caption="3. การบดอัดแน่นดินถมหลังกำแพงเป็นชั้นๆ (Compaction)",
                use_container_width=True
            )
        ...
        with col_img2:
            st.image(
                ...
                caption="2. การจัดเรียงบล็อกหน้ากำแพง (Segmental Concrete Block)",
                use_container_width=True
            )
            
            st.image(
                "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=600&q=80",
                caption="4. สภาพกำแพงกันดิน Geotextile ที่ก่อสร้างเสร็จสมบูรณ์",
                use_container_width=True
            )